...
Spatial autocorrelation can be tested by mapping the residuals. I have provided a cleaned shapefile of the NUTS3 (federal states) regions in Germany. The mapped residuals allow us to visualize under- and overpredictions and check for spatial clustering of residuals. To determine whether the spatial autocorrelation of residuals is statistically significant or not, one could [compute Moran's I](https://mgimond.github.io/Spatial/spatial-autocorrelation-in-r.html#app8_3). But since there is no discernible pattern of clustering - the residuals are randomly distributed -, I will skip this step.
